...
public class JdbcTemplateMain {//테스트를 위한 메인 클래스 //JdbcTemplate 클래스를 사용한 실습
	...
	public static void main(String[] args) {
		...
		dao.insert(myTest.makeGuestMessage("민경민", "하이방가"));
		...
		List<GuestMessage> list = dao.selet(1, count);
